			...
			<div class="row">
				<div class="span4">
					<div class="well">
						...
						<form:form action="sign-up" method="POST" modelAttribute="user">  <!-- user lay tu Controller -->
							<div class="control-group">
								<label class="control-label" for="inputEmail">E-mail address</label>
								<div class="controls">
									<form:input class="span3" type="email" placeholder="Email" path="user" /> <!-- user lay tu Users -->
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input class="span3" type="text" placeholder="Full name" path="display_name" />
								</div>
							</div>
							<div class="control-group">
